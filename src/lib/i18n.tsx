...
const translations = {
  bg: {
    ...
    "hero.headlineLine1": "Не губете клиенти,",
    "hero.headlineLine2": "докато чакат отговор.",
    "hero.sub": "Viber помощник и сайт, изградени за вашия бизнес — знае цените ви, записва час и отговаря денем и нощем.",
  ...
  en: {
    ...
    "hero.headlineLine1": "Stop losing clients",
    "hero.headlineLine2": "while they wait for a reply.",
    "hero.sub": "A Viber assistant and website built for your business — it knows your prices, books appointments, and replies day and night.",
